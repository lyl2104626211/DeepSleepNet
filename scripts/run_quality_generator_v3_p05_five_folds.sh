...
RESULT_ROOT=${RESULT_ROOT:-results/deepsleepnet_sleep_edf_paper_fpz_cz_eeg_eog_quality_generator_v3_safe_p05}
...
for fold in "${FOLD_LIST[@]}"; do
  ...
  echo "==> ${fold}: train quality-generator-v3 stage1 with internal EOG dropout p=${EOG_DROPOUT_PROB}"
  ...
  echo "==> ${fold}: train quality-generator-v3 stage2 with internal EOG dropout p=${EOG_DROPOUT_PROB}"
