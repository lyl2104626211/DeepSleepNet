...
CONFIG=${CONFIG:-configs/paper_sleep_edf_fpz_cz_eeg_eog_quality_generator_v3_p05.yaml}
...
RESULT_ROOT=${RESULT_ROOT:-results/deepsleepnet_sleep_edf_paper_fpz_cz_eeg_eog_quality_generator_v3_lite_gate_p05}
...
for fold in "${FOLD_LIST[@]}"; do
  ...
  echo "==> ${fold}: train quality-generator-v3-lite-gate stage1 with internal EOG dropout p=${EOG_DROPOUT_PROB}"
  ...
  echo "==> ${fold}: train quality-generator-v3-lite-gate stage2 with internal EOG dropout p=${EOG_DROPOUT_PROB}"
